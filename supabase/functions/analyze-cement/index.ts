...
- ЛАБОРАТОРНЫЕ ДАННЫЕ: извлеки ВСЮ реологию (PV, YP, СНС, θ-показания, растекаемость). Если θ даны — рассчитай PV и YP. Ищи реологию В ЛЮБОМ разделе документа.
