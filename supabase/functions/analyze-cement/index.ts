...
- ПРОВЕРЬ КОРРЕКТНОСТЬ ПРОГРАММЫ: пересчитай объёмы, давления, скорости, время — укажи на ошибки в математике и физике
- В конце — КОНКРЕТНЫЕ мероприятия с обоснованием
- Дай структурированный инженерный отчёт с таблицами (15 разделов). Начни с дисклеймера.`;
