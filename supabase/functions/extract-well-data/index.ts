...
- "Цемент от забоя до 800м" → cementRiseHeight: 800 (это высота подъёма, НЕ topDepthMD)
- "Чистый цемент 2500-2850м" → slurries[последний].topDepthMD: 2500 (нижний раствор, забой)
- "Лёгкий цемент 800-2500м" → slurries[первый].topDepthMD: 800 (верхний раствор)
...
КРИТИЧЕСКИЕ ПРАВИЛА ИНТЕРВАЛОВ ЦЕМЕНТА:
- topDepthMD — это глубина ВЕРХА данного раствора (откуда он начинается сверху)
- Растворы в массиве slurries ВСЕГДА сортируй СВЕРХУ ВНИЗ (первый = верхний/лёгкий, последний = нижний/чистый у забоя)
- Нижняя граница ПОСЛЕДНЕГО раствора = глубина спуска ОК (casingDepthMD), его НЕ нужно указывать
- Нижняя граница каждого раствора = topDepthMD следующего раствора
- ПРИМЕР для 2 растворов: "Лёгкий цемент 800-2500м, чистый цемент 2500-2850м":
  slurries[0]: {name: "Лёгкий", topDepthMD: 800}, slurries[1]: {name: "Чистый", topDepthMD: 2500}
  cementRiseHeight: 800
- ПРИМЕР для 1 раствора: "Цемент от 500м до забоя (2850м)":
  slurries[0]: {topDepthMD: 500}, cementRiseHeight: 500
- НЕ ПУТАЙ cementRiseHeight и topDepthMD! cementRiseHeight = глубина верха САМОГО ВЕРХНЕГО раствора
