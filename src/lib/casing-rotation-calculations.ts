...
export const CONNECTION_DATABASE: Record<string, ConnectionType[]> = {
  '114.3': [
    { id: 'btc-114', name: 'BTC', nameRu: 'ОТТМ (трапецеидальная)', manufacturer: 'API', type: 'buttress',
      ...
      canRotate: true, notes: 'Стандартная трапецеидальная. До 30 об/мин.' },
  ],
  '168.3': [
    ...
    { id: 'vam-top-168', name: 'VAM TOP', nameRu: 'VAM TOP (премиум)', manufacturer: 'Vallourec', type: 'premium',
      ...
      canRotate: true, notes: 'Газогерметичная. Допускает вращение.' },
  ],
  '177.8': [
    { id: 'btc-178', name: 'BTC', nameRu: 'ОТТМ', manufacturer: 'API', type: 'buttress',
      ...
      canRotate: true, notes: '' },
    { id: 'vam-top-178', name: 'VAM TOP', nameRu: 'VAM TOP (премиум)', manufacturer: 'Vallourec', type: 'premium',
  ...
  '426.0': [
    { id: 'btc-426', name: 'BTC', nameRu: 'ОТТМ', manufacturer: 'API', type: 'buttress',
      ...
      canRotate: true, notes: 'Вращение возможно при верхнем приводе.' },
  ],
};
